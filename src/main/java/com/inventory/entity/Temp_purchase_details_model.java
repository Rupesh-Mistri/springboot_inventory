...
public class Temp_purchase_details_model {
...
//	private long item_id;
	...
	public Temp_purchase_details_model() {}

	public Temp_purchase_details_model(item_model item, int item_rate, int quantity, LocalDateTime datetime, int status) {
		super();
		this.item = item;
		this.item_rate = item_rate;
		this.quantity = quantity;
